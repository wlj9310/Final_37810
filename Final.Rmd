...
2. Based on the plots, we think the performance of the sampler when c = 1 is ok. The autocorrection is good and the Kolmogorov-Smirnov Statistic is showing good result.
